...
Это фулл-стек приложение для просмотра и управления потоковых видео.
...
Это полнофункциональное **full-stack приложение** для просмотра и управления потоковым видео. Оно включает в себя:

1. **Видеоплеер** для воспроизведения потокового видео.
2. **Администраторский интерфейс**, который позволяет:
   - Создавать, обновлять и удалять видеопотоки.
   - Мониторить состояние потоков в реальном времени.
3. **Систему управления пользователями**:
...
4. **Управление ответственными лицами**:
...
![Пример работы](images/csm_presentation.gif)
